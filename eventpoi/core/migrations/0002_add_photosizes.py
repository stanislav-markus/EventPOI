...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['photologue.PhotoSize'].objects.get_or_create(name='avatar', width=80, height=80, crop=True)
        orm['photologue.PhotoSize'].objects.get_or_create(name='preview', width=200, height=220, crop=True)
    ...
    models = {
        ...
        u'core.poi': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['photologue.Photo']"}),
        ...
        u'core.userprofile': {
            ...
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['photologue.Photo']", 'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '70'}),
